...
package org.robotlegs.mvcs
{
	...
	public class Context extends ContextBase implements IContext
	{
		...
		protected const NULL_CONTEXT_VIEW:DisplayObjectContainer = new DisplayObjectContainer();
		...
		{
			super();
			_contextView = (contextView || NULL_CONTEXT_VIEW);
		...
		public function set contextView(value:DisplayObjectContainer):void
		{
			...
			{
				_contextView = (value || NULL_CONTEXT_VIEW);
		...
		*/
		...
		{
			if (_autoStartup && (contextView != NULL_CONTEXT_VIEW))
			{
		...
		{
			if ((contextView != NULL_CONTEXT_VIEW) && contextView.loaderInfo)
