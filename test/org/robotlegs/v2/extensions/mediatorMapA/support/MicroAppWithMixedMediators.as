...
package org.robotlegs.v2.extensions.mediatorMapA.support
{
	...
	import org.robotlegs.v2.extensions.mediatorMapA.support.TracingMediator;
	...
	import org.robotlegs.v2.extensions.mediatorMapA.bundles.RL1AndRL2MediatorsMediatorMapBundle;
	...
	public class MicroAppWithMixedMediators extends Sprite
	{
		...
		protected function addMappings(e:ContextBuilderEvent):void
		{
			...
			mediatorMapA.map(TracingMediator).toView(MovieClip);
