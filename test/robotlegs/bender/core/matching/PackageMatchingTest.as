...
package robotlegs.bender.core.matching
{
	...
	import robotlegs.bender.core.matching.support.a.PackagedTypeA;
	import robotlegs.bender.core.matching.support.b.PackagedTypeB;
	import robotlegs.bender.core.matching.support.c.PackagedTypeC;
	...
	public class PackageMatchingTest
	{
		...
		private const PACKAGE_A:String = "robotlegs.bender.core.matching.support.a";

		private const PACKAGE_B:String = "robotlegs.bender.core.matching.support.b";

		private const PACKAGE_C:String = "robotlegs.bender.core.matching.support.c";

		private const PARENT_PACKAGE:String = "robotlegs.bender.core.matching.support";
		...
		[Test(expects='robotlegs.bender.core.matching.TypeMatcherError')]
