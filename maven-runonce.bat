...
mvn -s settings.xml install:install-file -Dfile=lib/mockolate-0.12.2-flex.swc -Dversion=0.12.1 -Dclassifier=flex -Dpackaging=swc -DgroupId=mockolate -DartifactId=mockolate
