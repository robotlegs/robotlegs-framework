call mvn -s settings.xml install:install-file -Dfile=lib/Swiftsuspenders-v2.0.0b5.swc -DartifactId=swiftsuspenders -DgroupId=org.swiftsuspenders -Dversion=2.0.0-b4 -Dpackaging=swc
