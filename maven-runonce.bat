call mvn -s settings.xml install:install-file -Dfile=lib/Swiftsuspenders-v2.1.0.swc -DartifactId=swiftsuspenders -DgroupId=org.swiftsuspenders -Dversion=2.1.0 -Dpackaging=swc
