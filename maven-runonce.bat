call mvn -s settings.xml install:install-file -Dfile=lib/Swiftsuspenders-v2.0.0rc1.swc -DartifactId=swiftsuspenders -DgroupId=org.swiftsuspenders -Dversion=2.0.0-b4 -Dpackaging=swc
...
call mvn -s settings.xml install:install-file -Dfile=lib/mockolate-0.12.2-flex.swc -Dversion=0.12.2 -Dclassifier=flex -Dpackaging=swc -DgroupId=mockolate -DartifactId=mockolate
