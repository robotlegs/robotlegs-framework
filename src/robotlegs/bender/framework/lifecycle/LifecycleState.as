...
package robotlegs.bender.framework.lifecycle
{
	...
	public class LifecycleState
	{
		...
		public function LifecycleState(name:String, lifecycle:Lifecycle)
		{
			_name = name;
		...
		public function fromStates(... states):LifecycleState
		{
			validateLock();
		...
		public function toStates(transitionState:String, finalState:String):LifecycleState
		{
			validateLock();
		...
		public function withEvents(preTransitionEvent:String, transitionEvent:String, postTransitionEvent:String):LifecycleState
		{
			validateLock();
		...
		public function inReverse():LifecycleState
		{
			validateLock();
			_reverse = true;
		...
		public function withBeforeHandlers(... handlers):LifecycleState
		{
